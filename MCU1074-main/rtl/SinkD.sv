...
module SinkD(	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:34:7]
  ...
  input  [31:0] io_d_bits_data,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:36:14]
  ...
  input         io_way,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:36:14]
  input  [4:0]  io_set,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:36:14]
  ...
  output        io_bs_adr_bits_way,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:36:14]
  output [4:0]  io_bs_adr_bits_set,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:36:14]
  output [3:0]  io_bs_adr_bits_beat,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:36:14]
  output [31:0] io_bs_dat_data,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:36:14]
  output [4:0]  io_grant_req_set,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:36:14]
  output        io_grant_req_way,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:36:14]
  ...
  wire [1:0]  _d_q_io_deq_bits_source;	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
  ...
  wire [3:0]  r_beats1 = _d_q_io_deq_bits_opcode[0] ? ~(_r_beats1_decode_T[5:2]) : 4'h0;	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:106:36, :221:14, generators/rocket-chip/src/main/scala/util/package.scala:243:{46,71,76}, src/main/scala/chisel3/util/Decoupled.scala:362:21]
  ...
  reg  [3:0]  io_bs_adr_bits_beat_r;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:78:54]
  ...
  always @(posedge clock) begin	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:34:7]
    ...
    if (_d_q_io_deq_valid) begin	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
      ...
      io_bs_adr_bits_beat_r <= beat + {3'h0, io_bs_adr_ready};	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:78:{54,60}, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:234:25]
    end
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:34:7]
    ...
    initial begin	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:34:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:34:7]
        ...
        r_counter = _RANDOM[/*Zero width*/ 1'b0][3:0];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:34:7, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27]
        io_source_r = _RANDOM[/*Zero width*/ 1'b0][5:4];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:34:7, :57:53, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27]
        io_bs_adr_bits_beat_r = _RANDOM[/*Zero width*/ 1'b0][9:6];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:34:7, :78:54, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Queue2_TLBundleD_a32d32s2k3z3c d_q (	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
    .clock               (clock),
    .reset               (reset),
