...
module InclusiveCache(	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/InclusiveCache.scala:108:9]
  ...
  input  [3:0]  auto_ctrls_ctrl_in_a_bits_mask,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  input  [31:0] auto_ctrls_ctrl_in_a_bits_data,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  ...
  output [31:0] auto_ctrls_ctrl_in_d_bits_data,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  ...
  wire [31:0] nodeIn_b_bits_address = _inclusive_cache_bank_sched_io_in_b_bits_address | 32'h80000000;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/InclusiveCache.scala:137:29, generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/Parameters.scala:249:14]
  wire        contained = {_ctrls_io_flush_req_bits[63:32], _ctrls_io_flush_req_bits[31:15] ^ 17'h10000} == 49'h0;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/InclusiveCache.scala:103:43, generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:137:{31,41,46,59}]
  ...
  TLMonitor_32 monitor (	// @[generators/rocket-chip/src/main/scala/tilelink/Nodes.scala:27:25]
    ...
    .io_in_b_bits_address (nodeIn_b_bits_address),	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/Parameters.scala:249:14]
  ...
  assign auto_in_b_bits_address = nodeIn_b_bits_address;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/InclusiveCache.scala:108:9, generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/Parameters.scala:249:14]
  ...
  assign auto_out_a_bits_address = _inclusive_cache_bank_sched_io_out_a_bits_address | 32'h80000000;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/InclusiveCache.scala:108:9, :137:29, generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/Parameters.scala:249:14]
  assign auto_out_c_bits_address = _inclusive_cache_bank_sched_io_out_c_bits_address | 32'h80000000;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/InclusiveCache.scala:108:9, :137:29, generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/Parameters.scala:249:14]
endmodule
