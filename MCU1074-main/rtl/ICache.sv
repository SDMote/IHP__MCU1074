...
module ICache(	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:251:7]
  ...
  input  [31:0] auto_master_out_d_bits_data,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  ...
  wire        readEnable;	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:590:46]
  wire        wen;	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:570:32]
  wire        readEnable_0;	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:426:83]
  ...
  wire [22:0] _rockettile_icache_tag_array_0_RW0_rdata;	// @[generators/rocket-chip/src/main/scala/util/DescribedSRAM.scala:17:26]
  wire        s0_ren = io_req_ready & io_req_valid;	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:394:19, src/main/scala/chisel3/util/Decoupled.scala:51:35]
  ...
  wire [9:0]  r_beats1 = auto_master_out_d_bits_opcode[0] ? ~(_r_beats1_decode_T[11:2]) : 10'h0;	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:430:58, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:106:36, :221:14, generators/rocket-chip/src/main/scala/util/package.scala:243:{46,71,76}]
  ...
  wire [9:0]  refill_cnt = r_beats1 & ~_r_counter1_T;	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:221:14, :230:28, :234:{25,27}]
  wire        writeEnable = refill_one_beat & (r_counter == 10'h1 | r_beats1 == 10'h0);	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:391:39, :399:37, :430:58, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:221:14, :229:27, :232:{25,33,43}, :233:22]
  assign _tag_rdata_T = io_req_bits_addr[9:6];	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:426:42]
  assign readEnable_0 = ~writeEnable & s0_ren;	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:399:37, :426:{70,83}, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:233:22, src/main/scala/chisel3/util/Decoupled.scala:51:35]
  ...
  reg  [15:0] vb_array;	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:448:25]
  wire [15:0] _s1_vb_T_1 = vb_array >> io_s1_paddr[9:6];	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:448:25, :508:25, :859:21]
  wire        s1_hit = _s1_vb_T_1[0] & _rockettile_icache_tag_array_0_RW0_rdata[21:0] == io_s1_paddr[31:10];	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:361:40, :493:30, :508:25, :514:{26,33}, generators/rocket-chip/src/main/scala/util/DescribedSRAM.scala:17:26, generators/rocket-chip/src/main/scala/util/package.scala:163:13]
  assign wen = refill_one_beat & ~invalidated;	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:367:24, :391:39, :570:{32,35}]
  assign readEnable = ~wen & s0_ren;	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:570:32, :590:{41,46}, src/main/scala/chisel3/util/Decoupled.scala:51:35]
  ...
  wire [31:0] _vb_array_T_3 = 32'h1 << refill_paddr[9:6];	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:386:31, :452:32, :859:21]
  ...
  always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:251:7]
    if (reset) begin	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:251:7]
      ...
      r_counter <= 10'h0;	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:430:58, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27]
      vb_array <= 16'h0;	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:448:25]
    end
    else begin	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:251:7]
      s1_valid <= s0_ren;	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:341:25, src/main/scala/chisel3/util/Decoupled.scala:51:35]
      s2_valid <= s1_valid & ~io_s1_kill;	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:341:25, :363:{25,35,38}]
      refill_valid <= ~writeEnable & (auto_master_out_a_ready & s2_request_refill | refill_valid);	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:368:29, :385:35, :399:37, :830:{22,37}, :831:{22,37}, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:233:22, src/main/scala/chisel3/util/Decoupled.scala:51:35]
      if (auto_master_out_d_valid)	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
        r_counter <= r_counter == 10'h0 ? r_beats1 : _r_counter1_T;	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:430:58, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:221:14, :229:27, :230:28, :231:25, :236:21]
      if (io_invalidate)	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:256:14]
        ...
        vb_array <= writeEnable & ~invalidated ? vb_array | _vb_array_T_3[15:0] : ~(~vb_array | _vb_array_T_3[15:0]);	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:367:24, :399:37, :448:25, :452:{32,72,75}, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:233:22]
    end
    ...
    if (s1_valid) begin	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:341:25]
      s2_dout_0 <= _rockettile_icache_data_arrays_0_0_RW0_rdata;	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:612:26, generators/rocket-chip/src/main/scala/util/DescribedSRAM.scala:17:26]
      s2_tl_error <= s1_hit & _rockettile_icache_tag_array_0_RW0_rdata[22];	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:361:40, :518:32, :615:30, generators/rocket-chip/src/main/scala/util/DescribedSRAM.scala:17:26, generators/rocket-chip/src/main/scala/util/package.scala:163:13]
    end
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:251:7]
    ...
    initial begin	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:251:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:251:7]
        ...
        s2_valid = _RANDOM[3'h1][5];	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:251:7, :363:25]
        s2_hit = _RANDOM[3'h1][6];	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:251:7, :363:25, :364:23]
        invalidated = _RANDOM[3'h1][7];	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:251:7, :363:25, :367:24]
        refill_valid = _RANDOM[3'h1][8];	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:251:7, :363:25, :368:29]
        s2_request_refill_REG = _RANDOM[3'h1][11];	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:251:7, :363:25, :385:45]
        refill_paddr = {_RANDOM[3'h1][31:12], _RANDOM[3'h2][11:0]};	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:251:7, :363:25, :386:31]
        r_counter = _RANDOM[3'h3][21:12];	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:251:7, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27]
        accruedRefillError = _RANDOM[3'h3][22];	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:251:7, :428:31, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27]
        vb_array = {_RANDOM[3'h3][31:23], _RANDOM[3'h4][6:0]};	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:251:7, :448:25, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27]
        s2_dout_0 = {_RANDOM[3'h5][31:18], _RANDOM[3'h6][17:0]};	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:251:7, :612:26]
        s2_tl_error = _RANDOM[3'h6][19];	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:251:7, :612:26, :615:30]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  rockettile_icache_tag_array_0 rockettile_icache_tag_array_0 (	// @[generators/rocket-chip/src/main/scala/util/DescribedSRAM.scala:17:26]
    .RW0_addr  (writeEnable ? refill_paddr[9:6] : _tag_rdata_T),	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:386:31, :399:37, :426:42, :859:21, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:233:22, generators/rocket-chip/src/main/scala/util/DescribedSRAM.scala:17:26]
    .RW0_en    (readEnable_0 | writeEnable),	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:399:37, :426:83, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:233:22, generators/rocket-chip/src/main/scala/util/DescribedSRAM.scala:17:26]
    .RW0_clk   (clock),
    .RW0_wmode (refill_one_beat),	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:391:39]
    .RW0_wdata ({refillError, refill_paddr[31:10]}),	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:386:31, :388:33, :430:43, :435:34]
  ...
  rockettile_icache_data_arrays_0_0 rockettile_icache_data_arrays_0_0 (	// @[generators/rocket-chip/src/main/scala/util/DescribedSRAM.scala:17:26]
    .RW0_addr  (refill_one_beat ? {refill_paddr[9:6], 4'h0} | refill_cnt[7:0] : io_req_bits_addr[9:2]),	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:386:31, :391:39, :565:31, :574:{10,40,67}, :859:21, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:234:25]
    .RW0_en    (readEnable | wen),	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:570:32, :590:46, generators/rocket-chip/src/main/scala/util/DescribedSRAM.scala:17:26]
    .RW0_clk   (clock),
    .RW0_wmode (refill_one_beat),	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:391:39]
