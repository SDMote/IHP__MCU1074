...
module Queue1_RegMapperInput_i10_m4(	// @[generators/rocket-chip/src/main/scala/regmapper/RegMapper.scala:71:32]
  ...
  input  [9:0]  io_enq_bits_index,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  ...
  output [9:0]  io_deq_bits_index,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/rocket-chip/src/main/scala/regmapper/RegMapper.scala:71:32]
    ...
    logic [31:0] _RANDOM[0:1];	// @[generators/rocket-chip/src/main/scala/regmapper/RegMapper.scala:71:32]
    initial begin	// @[generators/rocket-chip/src/main/scala/regmapper/RegMapper.scala:71:32]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/rocket-chip/src/main/scala/regmapper/RegMapper.scala:71:32]
        for (logic [1:0] i = 2'h0; i < 2'h2; i += 2'h1) begin
          _RANDOM[i[0]] = `RANDOM;	// @[generators/rocket-chip/src/main/scala/regmapper/RegMapper.scala:71:32]
        end	// @[generators/rocket-chip/src/main/scala/regmapper/RegMapper.scala:71:32]
        ram = {_RANDOM[1'h0][31:1], _RANDOM[1'h1][29:0]};	// @[generators/rocket-chip/src/main/scala/regmapper/RegMapper.scala:71:32, src/main/scala/chisel3/util/Decoupled.scala:256:91]
        full = _RANDOM[1'h0][0];	// @[generators/rocket-chip/src/main/scala/regmapper/RegMapper.scala:71:32, src/main/scala/chisel3/util/Decoupled.scala:256:91, :259:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_deq_bits_index = ram[10:1];	// @[generators/rocket-chip/src/main/scala/regmapper/RegMapper.scala:71:32, src/main/scala/chisel3/util/Decoupled.scala:256:91]
  assign io_deq_bits_mask = ram[46:43];	// @[generators/rocket-chip/src/main/scala/regmapper/RegMapper.scala:71:32, src/main/scala/chisel3/util/Decoupled.scala:256:91]
  assign io_deq_bits_extra_tlrr_extra_source = ram[58:47];	// @[generators/rocket-chip/src/main/scala/regmapper/RegMapper.scala:71:32, src/main/scala/chisel3/util/Decoupled.scala:256:91]
  assign io_deq_bits_extra_tlrr_extra_size = ram[60:59];	// @[generators/rocket-chip/src/main/scala/regmapper/RegMapper.scala:71:32, src/main/scala/chisel3/util/Decoupled.scala:256:91]
endmodule
