...
module TLFragmenter_BootROM(	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9]
  ...
  always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9]
    if (reset) begin	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9]
      ...
      if (_GEN_0)	// @[src/main/scala/chisel3/util/Decoupled.scala:51:35]
        acknum <= dFirst ? auto_anon_out_d_bits_source[3:0] : acknum - 4'h1;	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:201:29, :204:41, :205:29, :221:{24,55}]
  ...
  Repeater_TLBundleA_a17d32s7k1z3u repeater (	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:274:30]
    .clock               (clock),
    .reset               (reset),
  ...
  assign auto_anon_out_a_bits_address = {_repeater_io_deq_bits_address[16:6], _repeater_io_deq_bits_address[5:0] | {~(aFragnum | _aOrigOH1_T[5:2]), 2'h0}};	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9, :274:30, :305:30, :316:{49,51,88,111}, generators/rocket-chip/src/main/scala/util/package.scala:243:{71,76}]
