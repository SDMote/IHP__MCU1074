...
module MulDiv(	// @[generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:40:7]
  ...
  wire [33:0] _prod_T_4 = {{33{remainder[32]}}, remainder[0]} * {divisor[32], divisor} + {remainder[65], remainder[65:33]};	// @[generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:60:20, :61:22, :107:31, :108:31, :109:24, :112:{38,67,76}]
  ...
  wire        _GEN_2 = _GEN_1 & count == 6'h1F;	// @[generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:54:18, :101:57, :106:{39,50}, :124:{25,55}, :125:13]
  ...
  always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:40:7]
    ...
    if (_GEN_5) begin	// @[src/main/scala/chisel3/util/Decoupled.scala:51:35]
      ...
      if (_GEN_3) begin	// @[generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:129:39]
        ...
        remainder <= {_prod_T_4[33:1], count == 6'h1E & neg_out, _prod_T_4[0], remainder[31:1]};	// @[generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:54:18, :57:20, :61:22, :109:24, :112:76, :113:38, :114:{32,61}, :120:26, :121:{21,34,67}]
      end
