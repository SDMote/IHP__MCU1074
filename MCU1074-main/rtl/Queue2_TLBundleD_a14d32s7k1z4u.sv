...
module Queue2_TLBundleD_a14d32s7k1z4u(	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
  ...
  ram_2x51 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_corrupt, 34'h2, io_enq_bits_source, io_enq_bits_size, 2'h0, io_enq_bits_opcode})	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14, :256:91]
  ...
  assign io_deq_bits_data = _ram_ext_R0_data[49:18];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
