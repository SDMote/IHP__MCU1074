...
module SinkA(	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:38:7]
  ...
  output [3:0]  io_req_bits_tag,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:40:14]
  ...
  output [4:0]  io_req_bits_set,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:40:14]
  ...
  input  [3:0]  io_a_bits_mask,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:40:14]
  input  [31:0] io_a_bits_data,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:40:14]
  ...
  output [31:0] io_pb_beat_data,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:40:14]
  output [3:0]  io_pb_beat_mask,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:40:14]
  ...
  reg  [3:0]  first_counter;	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27]
  wire        first = first_counter == 4'h0;	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27, :231:25]
  ...
  always @(posedge clock) begin	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:38:7]
    if (reset) begin	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:38:7]
      ...
      first_counter <= 4'h0;	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27]
    end
      ...
      if (io_a_ready_0 & io_a_valid)	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:78:{25,39}, src/main/scala/chisel3/util/Decoupled.scala:51:35]
        first_counter <= first ? (io_a_bits_opcode[2] ? 4'h0 : ~(_first_beats1_decode_T[5:2])) : first_counter - 4'h1;	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:92:37, :221:14, :229:27, :230:28, :231:25, :236:21, generators/rocket-chip/src/main/scala/util/package.scala:243:{46,71,76}]
    end
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:38:7]
    ...
    initial begin	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:38:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:38:7]
        ...
        first_counter = _RANDOM[1'h1][11:8];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:38:7, :52:22, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27]
        put_r = _RANDOM[1'h1][17:12];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:38:7, :52:22, :84:42]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_req_bits_tag = io_a_bits_address[14:11];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/Parameters.scala:215:21, :216:22, :217:19, generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:38:7]
  assign io_req_bits_offset = io_a_bits_address[5:0];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/Parameters.scala:215:21, :218:50, generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:38:7]
  assign io_req_bits_put = put;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:38:7, :84:16]
  assign io_req_bits_set = io_a_bits_address[10:6];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/Parameters.scala:215:21, :216:22, :218:28, generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:38:7]
