...
module TLPLIC(	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Plic.scala:132:9]
  ...
  wire             completerDev;	// @[generators/rocket-chip/src/main/scala/util/package.scala:163:13]
  ...
  wire [23:0]      _out_back_front_q_io_deq_bits_index;	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
  wire [31:0]      _out_back_front_q_io_deq_bits_data;	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
  wire [3:0]       _out_back_front_q_io_deq_bits_mask;	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
  ...
  wire             _out_T_9 = {_out_back_front_q_io_deq_bits_index[23:20], _out_back_front_q_io_deq_bits_index[18:12], _out_back_front_q_io_deq_bits_index[10:1]} == 21'h0;	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
  wire [31:0]      out_backMask = {{8{_out_back_front_q_io_deq_bits_mask[3]}}, {8{_out_back_front_q_io_deq_bits_mask[2]}}, {8{_out_back_front_q_io_deq_bits_mask[1]}}, {8{_out_back_front_q_io_deq_bits_mask[0]}}};	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
  wire             claimer_0 = _out_wofireMux_T & _out_back_front_q_io_deq_bits_read & out_backSel_5 & _out_T_9 & (|out_backMask);	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
  assign completerDev = _out_back_front_q_io_deq_bits_data[0];	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24, generators/rocket-chip/src/main/scala/util/package.scala:163:13]
  ...
  `endif // not def SYNTHESIS
  wire [1:0]       _out_completer_0_T = {enables_0_0, 1'h0} >> completerDev;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Plic.scala:132:9, :178:26, :183:52, :301:51, generators/rocket-chip/src/main/scala/util/package.scala:163:13]
  assign completer_0 = _out_wofireMux_T_2 & out_backSel_5 & _out_T_9 & (&out_backMask) & _out_completer_0_T[0];	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Plic.scala:301:{35,51}, generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
  wire [2:0]       out_oindex = {_out_back_front_q_io_deq_bits_index[19], _out_back_front_q_io_deq_bits_index[11], _out_back_front_q_io_deq_bits_index[0]};	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
  wire [2:0]       _GEN = {_out_back_front_q_io_deq_bits_index[19], _out_back_front_q_io_deq_bits_index[11], _out_back_front_q_io_deq_bits_index[0]};	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24, src/main/scala/chisel3/util/OneHot.scala:58:35]
  assign out_backSel_5 = _GEN == 3'h5;	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24, src/main/scala/chisel3/util/OneHot.scala:58:35]
  ...
  assign _out_wofireMux_T_2 = _out_wofireMux_T & ~_out_back_front_q_io_deq_bits_read;	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
  wire [7:0]       _GEN_0 = {{1'h1}, {1'h1}, {_out_T_9}, {_out_T_9}, {1'h1}, {_out_T_9}, {_out_T_9}, {{_out_back_front_q_io_deq_bits_index[23:20], _out_back_front_q_io_deq_bits_index[18:12], _out_back_front_q_io_deq_bits_index[10:1]} == 21'h200}};	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Plic.scala:132:9, generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24, generators/rocket-chip/src/main/scala/util/MuxLiteral.scala:49:10]
  wire [7:0][31:0] _GEN_1 = {{32'h0}, {32'h0}, {{31'h0, maxDevs_0}}, {{31'h0, threshold_0}}, {32'h0}, {{30'h0, enables_0_0, 1'h0}}, {{31'h0, priority_0}}, {{30'h0, pending_0, 1'h0}}};	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Plic.scala:132:9, :167:31, :170:31, :172:26, :178:26, :185:22, generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24, generators/rocket-chip/src/main/scala/util/MuxLiteral.scala:49:{10,48}]
  ...
  always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Plic.scala:132:9]
    if (_out_wofireMux_T_2 & _GEN == 3'h1 & _out_T_9 & _out_back_front_q_io_deq_bits_mask[0])	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24, src/main/scala/chisel3/util/OneHot.scala:58:35]
      priority_0 <= _out_back_front_q_io_deq_bits_data[0];	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Plic.scala:167:31, generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
    if (_out_wofireMux_T_2 & _GEN == 3'h4 & _out_T_9 & _out_back_front_q_io_deq_bits_mask[0])	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24, src/main/scala/chisel3/util/OneHot.scala:58:35]
    ...
    if (_out_wofireMux_T_2 & _GEN == 3'h2 & _out_T_9 & _out_back_front_q_io_deq_bits_mask[0])	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24, src/main/scala/chisel3/util/OneHot.scala:58:35]
  ...
  Queue1_RegMapperInput_i24_m4 out_back_front_q (	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
    .clock                               (clock),
    .reset                               (reset),
    ...
    .io_enq_bits_index                   (auto_in_a_bits_address[25:2]),	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:192:34, generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:75:19]
  ...
  assign auto_in_d_bits_data = _GEN_0[out_oindex] ? _GEN_1[out_oindex] : 32'h0;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Plic.scala:132:9, generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24, generators/rocket-chip/src/main/scala/util/MuxLiteral.scala:49:10]
endmodule
