...
module InclusiveCacheControl(	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/Control.scala:38:9]
  ...
  input  [3:0]  auto_ctrl_in_a_bits_mask,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  input  [31:0] auto_ctrl_in_a_bits_data,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  ...
  output [31:0] auto_ctrl_in_d_bits_data,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  ...
  wire        out_oindex;	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
  ...
  wire [9:0]  _out_back_front_q_io_deq_bits_index;	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
  ...
  wire [8:0]  _GEN = {_out_back_front_q_io_deq_bits_index[9:8], _out_back_front_q_io_deq_bits_index[6:0]};	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
  wire        _out_T_3 = _GEN == 9'h10;	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
  wire [31:0] out_frontMask = {{8{auto_ctrl_in_a_bits_mask[3]}}, {8{auto_ctrl_in_a_bits_mask[2]}}, {8{auto_ctrl_in_a_bits_mask[1]}}, {8{auto_ctrl_in_a_bits_mask[0]}}};	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
  ...
  assign out_oindex = _out_back_front_q_io_deq_bits_index[7];	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
  ...
  wire        out_iready = in_bits_read | ~(auto_ctrl_in_a_bits_address[9]) | ~flushInValid | ~(&out_frontMask) | {auto_ctrl_in_a_bits_address[11:10], auto_ctrl_in_a_bits_address[8:2]} != 9'h10;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/Control.scala:45:33, :64:23, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:192:34, generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:74:36, :75:19, :87:24, generators/rocket-chip/src/main/scala/util/MuxLiteral.scala:49:10]
  wire        out_oready = _out_back_front_q_io_deq_bits_read | ~out_oindex | flushOutValid | ~(&out_backMask) | {_out_back_front_q_io_deq_bits_index[9:8], _out_back_front_q_io_deq_bits_index[6:0]} != 9'h10;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/Control.scala:47:33, generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24, generators/rocket-chip/src/main/scala/util/MuxLiteral.scala:49:10]
  wire        in_ready = _out_back_front_q_io_enq_ready & out_iready;	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24, generators/rocket-chip/src/main/scala/util/MuxLiteral.scala:49:10]
  wire        out_valid = _out_back_front_q_io_deq_valid & out_oready;	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24, generators/rocket-chip/src/main/scala/util/MuxLiteral.scala:49:10]
  ...
  wire        _GEN_0 = ~io_flush_match & flushInValid;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/Control.scala:45:33, :56:{11,27}]
  wire        out_f_wivalid_4 = auto_ctrl_in_a_valid & _out_back_front_q_io_enq_ready & ~in_bits_read & auto_ctrl_in_a_bits_address[9] & {auto_ctrl_in_a_bits_address[11:10], auto_ctrl_in_a_bits_address[8:2]} == 9'h10 & (&out_frontMask);	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:74:36, :87:24]
  always @(posedge clock) begin	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/Control.scala:38:9]
    if (reset) begin	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/Control.scala:38:9]
      ...
      flushInValid <= out_f_wivalid_4 | ~(_GEN_0 | io_flush_req_ready) & flushInValid;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/Control.scala:45:33, :52:{31,46}, :56:{27,44}, :57:20, :63:{21,36}, generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
      flushOutValid <= _GEN_0 | io_flush_resp | ~(_out_back_front_q_io_deq_valid & auto_ctrl_in_d_ready & _out_wofireMux_T_1 & out_oindex & _out_T_3 & (&out_backMask)) & flushOutValid;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/Control.scala:47:33, :50:{26,42}, :51:{26,42}, :56:{27,44}, :58:21, generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
    end
    if (out_f_wivalid_4 & ~flushInValid)	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/Control.scala:45:33, :64:{20,23}, generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
      flushInAddress <= {28'h0, auto_ctrl_in_a_bits_data, 4'h0};	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/Control.scala:46:29, :64:{55,63}]
  end // always @(posedge)
  ...
  Queue1_RegMapperInput_i10_m4 out_back_front_q (	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
    .clock                               (clock),
    .reset                               (reset),
    .io_enq_ready                        (_out_back_front_q_io_enq_ready),
    .io_enq_valid                        (auto_ctrl_in_a_valid & out_iready),	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24, generators/rocket-chip/src/main/scala/util/MuxLiteral.scala:49:10]
    .io_enq_bits_read                    (in_bits_read),	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:74:36]
    .io_enq_bits_index                   (auto_ctrl_in_a_bits_address[11:2]),	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:192:34, generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:75:19]
    ...
    .io_deq_ready                        (auto_ctrl_in_d_ready & out_oready),	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24, generators/rocket-chip/src/main/scala/util/MuxLiteral.scala:49:10]
