...
module ram_2x51(	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  input         R0_addr,
  input         R0_en,
  input         R0_clk,
  output [50:0] R0_data,
  ...
  reg [50:0] Memory[0:1];	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
    ...
    initial begin	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
      ...
      `ifdef RANDOMIZE_MEM_INIT	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
        for (logic [1:0] i = 2'h0; i < 2'h2; i += 2'h1) begin
          ...
          Memory[i[0]] = _RANDOM_MEM[50:0];	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
        end
      `endif // RANDOMIZE_MEM_INIT
    end // initial
  `endif // ENABLE_INITIAL_MEM_
  assign R0_data = R0_en ? Memory[R0_addr] : 51'bx;	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
endmodule
