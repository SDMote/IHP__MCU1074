...
module ram_20x76(	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  input  [4:0]  R0_addr,
  input         R0_en,
  input         R0_clk,
  output [75:0] R0_data,
  ...
  reg [75:0] Memory[0:19];	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
    ...
    initial begin	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
      ...
      `ifdef RANDOMIZE_MEM_INIT	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
        for (logic [4:0] i = 5'h0; i < 5'h14; i += 5'h1) begin
          ...
          Memory[i] = _RANDOM_MEM[75:0];	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
        end
      `endif // RANDOMIZE_MEM_INIT
    end // initial
  `endif // ENABLE_INITIAL_MEM_
  assign R0_data = R0_en ? Memory[R0_addr] : 76'bx;	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
endmodule
