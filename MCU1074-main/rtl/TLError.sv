...
module TLError(	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:21:9]
  ...
  wire [9:0]      a_last_beats1 = _a_q_io_deq_bits_opcode[2] ? 10'h0 : ~(_a_last_beats1_decode_T[11:2]);	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:92:37, :221:14, generators/rocket-chip/src/main/scala/util/package.scala:243:{46,71,76}, src/main/scala/chisel3/util/Decoupled.scala:362:21]
  reg  [9:0]      a_last_counter;	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27]
  wire            a_last = a_last_counter == 10'h1 | a_last_beats1 == 10'h0;	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:221:14, :229:27, :232:{25,33,43}]
  wire [26:0]     _r_beats1_decode_T = 27'hFFF << _GEN_0;	// @[generators/rocket-chip/src/main/scala/util/package.scala:243:71]
  wire [9:0]      r_beats1 = da_bits_opcode[0] ? ~(_r_beats1_decode_T[11:2]) : 10'h0;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:38:21, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:106:36, :221:14, generators/rocket-chip/src/main/scala/util/package.scala:243:{46,71,76}]
  reg  [9:0]      r_counter;	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27]
  wire            a_q_io_deq_ready = auto_in_d_ready & (r_counter == 10'h1 | r_beats1 == 10'h0) | ~a_last;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:35:{26,46,49}, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:221:14, :229:27, :232:{25,33,43}]
  ...
  always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:21:9]
    if (reset) begin	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:21:9]
      a_last_counter <= 10'h0;	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27]
      ...
      if (a_q_io_deq_ready & _a_q_io_deq_valid)	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:35:46, src/main/scala/chisel3/util/Decoupled.scala:51:35, :362:21]
        a_last_counter <= a_last_counter == 10'h0 ? a_last_beats1 : a_last_counter - 10'h1;	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:221:14, :229:27, :230:28, :231:25, :236:21]
      if (auto_in_d_ready & da_valid)	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:36:25, src/main/scala/chisel3/util/Decoupled.scala:51:35]
        r_counter <= r_counter == 10'h0 ? r_beats1 : r_counter - 10'h1;	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:221:14, :229:27, :230:28, :231:25, :236:21]
    end
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:21:9]
    ...
    initial begin	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:21:9]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:21:9]
        ...
        a_last_counter = _RANDOM[/*Zero width*/ 1'b0][10:1];	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:21:9, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27]
        r_counter = _RANDOM[/*Zero width*/ 1'b0][20:11];	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:21:9, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Queue1_TLBundleA_a14d32s7k1z4u a_q (	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
    .clock               (clock),
    .reset               (reset),
