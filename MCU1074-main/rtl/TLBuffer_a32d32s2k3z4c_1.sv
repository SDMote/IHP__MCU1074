...
module TLBuffer_a32d32s2k3z4c_1(	// @[generators/rocket-chip/src/main/scala/tilelink/Buffer.scala:40:9]
  ...
  output [3:0]  auto_in_b_bits_mask,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  ...
  wire [3:0]  _nodeIn_b_q_io_deq_bits_mask;	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
  ...
  Queue2_TLBundleA_a32d32s2k3z4c nodeOut_a_q (	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
    .clock               (clock),
    .reset               (reset),
  ...
  Queue2_TLBundleD_a32d32s2k3z4c nodeIn_d_q (	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
    .clock               (clock),
    .reset               (reset),
  ...
  Queue2_TLBundleB_a32d32s2k3z4c nodeIn_b_q (	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
    .clock               (clock),
    .reset               (reset),
  ...
  Queue2_TLBundleC_a32d32s2k3z4c nodeOut_c_q (	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
    .clock               (clock),
    .reset               (reset),
  ...
  Queue2_TLBundleE_a32d32s2k3z4c nodeOut_e_q (	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
    .clock            (clock),
    .reset            (reset),
