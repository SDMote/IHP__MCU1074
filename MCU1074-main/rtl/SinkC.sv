...
module SinkC(	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:41:7]
  ...
  output [3:0]  io_req_bits_tag,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:43:14]
  ...
  output [4:0]  io_req_bits_set,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:43:14]
  ...
  output [4:0]  io_resp_bits_set,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:43:14]
  output [3:0]  io_resp_bits_tag,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:43:14]
  ...
  input  [31:0] io_c_bits_data,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:43:14]
  input         io_c_bits_corrupt,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:43:14]
  output [4:0]  io_set,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:43:14]
  input         io_way,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:43:14]
  ...
  output        io_bs_adr_bits_way,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:43:14]
  output [4:0]  io_bs_adr_bits_set,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:43:14]
  output [3:0]  io_bs_adr_bits_beat,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:43:14]
  output        io_bs_adr_bits_mask,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:43:14]
  output [31:0] io_bs_dat_data,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:43:14]
  ...
  output [31:0] io_rel_beat_data,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:43:14]
  ...
  wire [31:0] _c_q_io_deq_bits_data;	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
  ...
  wire [3:0]  r_beats1 = _c_q_io_deq_bits_opcode[0] ? ~(_r_beats1_decode_T[5:2]) : 4'h0;	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:102:36, :221:14, generators/rocket-chip/src/main/scala/util/package.scala:243:{46,71,76}, src/main/scala/chisel3/util/Decoupled.scala:362:21]
  reg  [3:0]  r_counter;	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27]
  wire [3:0]  _r_counter1_T = r_counter - 4'h1;	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27, :230:28]
  wire        last = r_counter == 4'h1 | r_beats1 == 4'h0;	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:221:14, :229:27, :232:{25,33,43}]
  wire [3:0]  beat = r_beats1 & ~_r_counter1_T;	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:221:14, :230:28, :234:{25,27}]
  ...
  `endif // not def SYNTHESIS
  reg  [4:0]  io_set_r;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:92:42]
  wire [4:0]  io_set_0 = _c_q_io_deq_valid ? _c_q_io_deq_bits_address[10:6] : io_set_r;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/Parameters.scala:215:21, :216:22, :218:28, generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:92:{18,42}, src/main/scala/chisel3/util/Decoupled.scala:362:21]
  reg  [31:0] io_bs_dat_data_r;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:98:34]
  ...
  reg  [3:0]  bs_adr_bits_beat_r;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:103:53]
  ...
  always @(posedge clock) begin	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:41:7]
    if (reset) begin	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:41:7]
      r_counter <= 4'h0;	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27]
    ...
    if (_c_q_io_deq_valid) begin	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
      ...
      io_set_r <= _c_q_io_deq_bits_address[10:6];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/Parameters.scala:215:21, :216:22, :218:28, generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:92:42, src/main/scala/chisel3/util/Decoupled.scala:362:21]
      bs_adr_bits_beat_r <= beat + {3'h0, _io_bs_adr_q_io_enq_ready};	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:103:{53,59}, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:234:25, src/main/scala/chisel3/util/Decoupled.scala:362:21]
    end
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:41:7]
    ...
    logic [31:0] _RANDOM[0:1];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:41:7]
    initial begin	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:41:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:41:7]
        for (logic [1:0] i = 2'h0; i < 2'h2; i += 2'h1) begin
          _RANDOM[i[0]] = `RANDOM;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:41:7]
        end	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:41:7]
        r_counter = _RANDOM[1'h0][3:0];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:41:7, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27]
        resp_r = _RANDOM[1'h0][4];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:41:7, :79:48, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27]
        io_set_r = _RANDOM[1'h0][9:5];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:41:7, :92:42, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27]
        io_bs_dat_data_r = {_RANDOM[1'h0][31:10], _RANDOM[1'h1][9:0]};	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:41:7, :98:34, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27]
        bs_adr_bits_beat_r = _RANDOM[1'h1][13:10];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:41:7, :98:34, :103:53]
        lists = _RANDOM[1'h1][15:14];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:41:7, :98:34, :116:24]
        put_r = _RANDOM[1'h1][17:16];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:41:7, :98:34, :140:44]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Queue2_TLBundleC_a32d32s6k3z3c c_q (	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
    .clock               (clock),
    .reset               (reset),
  ...
  ListBuffer_PutBufferCEntry_q2_e32 putbuffer (	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:115:27]
    .clock                     (clock),
    .reset                     (reset),
  ...
  assign io_req_bits_tag = _c_q_io_deq_bits_address[14:11];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/Parameters.scala:215:21, :216:22, :217:19, generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:41:7, src/main/scala/chisel3/util/Decoupled.scala:362:21]
  assign io_req_bits_offset = _c_q_io_deq_bits_address[5:0];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/Parameters.scala:215:21, :218:50, generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:41:7, src/main/scala/chisel3/util/Decoupled.scala:362:21]
  ...
  assign io_req_bits_set = _c_q_io_deq_bits_address[10:6];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/Parameters.scala:215:21, :216:22, :218:28, generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:41:7, src/main/scala/chisel3/util/Decoupled.scala:362:21]
  ...
  assign io_resp_bits_set = _c_q_io_deq_bits_address[10:6];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/Parameters.scala:215:21, :216:22, :218:28, generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:41:7, src/main/scala/chisel3/util/Decoupled.scala:362:21]
  assign io_resp_bits_tag = _c_q_io_deq_bits_address[14:11];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/Parameters.scala:215:21, :216:22, :217:19, generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:41:7, src/main/scala/chisel3/util/Decoupled.scala:362:21]
