...
module TilePRCIDomain(	// @[generators/rocket-chip/src/main/scala/prci/ClockDomain.scala:14:9]
  ...
  output [31:0] auto_tl_master_clock_xing_out_c_bits_data,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  ...
  wire [3:0]  _buffer_auto_in_b_bits_mask;	// @[generators/rocket-chip/src/main/scala/tilelink/Buffer.scala:75:28]
  ...
  wire [3:0]  _element_reset_domain_rockettile_auto_buffer_out_a_bits_mask;	// @[generators/rocket-chip/src/main/scala/subsystem/HasTiles.scala:164:59]
  wire [31:0] _element_reset_domain_rockettile_auto_buffer_out_a_bits_data;	// @[generators/rocket-chip/src/main/scala/subsystem/HasTiles.scala:164:59]
  ...
  wire [31:0] _element_reset_domain_rockettile_auto_buffer_out_c_bits_data;	// @[generators/rocket-chip/src/main/scala/subsystem/HasTiles.scala:164:59]
  ...
  TLBuffer_a32d32s2k3z4c_1 buffer (	// @[generators/rocket-chip/src/main/scala/tilelink/Buffer.scala:75:28]
    .clock                   (auto_tap_clock_in_clock),
    .reset                   (auto_tap_clock_in_reset),
