...
module TLROM(	// @[generators/rocket-chip/src/main/scala/devices/tilelink/BootROM.scala:41:9]
  ...
  assign auto_in_d_bits_data = (|(auto_in_a_bits_address[15:12])) ? 32'h0 : _GEN[auto_in_a_bits_address[11:2]];	// @[generators/rocket-chip/src/main/scala/devices/tilelink/BootROM.scala:41:9, :55:34, :56:64, :57:{47,53}]
endmodule
